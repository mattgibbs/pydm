  ...
  def send_new_value(self, pvname=None, value=None, char_value=None, units=None,
    ...
    if value is not None:
      if count > 1:
        ...
        if ftype in (epics.dbr.INT,  epics.dbr.CTRL_INT,  epics.dbr.TIME_INT,
                     epics.dbr.LONG, epics.dbr.CTRL_LONG, epics.dbr.TIME_LONG,
                     epics.dbr.ENUM, epics.dbr.CTRL_ENUM, epics.dbr.TIME_ENUM):
          self.new_value_signal[int].emit(int(value))
        elif ftype in (epics.dbr.CTRL_FLOAT,  epics.dbr.FLOAT,  epics.dbr.TIME_FLOAT,
